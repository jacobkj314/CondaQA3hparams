...
def forwardCE(
        ...
        if labels is not None:
            ...
            loss = loss_fct(lm_logits.view(-1, lm_logits.size(-1)), labels.view(-1))*(1-lam) + ceLoss*(lam) # # # I added the ceLoss part # # # Also added lam for hyperparameter tuning
